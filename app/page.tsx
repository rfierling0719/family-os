...
export default function Home() {
  return (
    <main className="shell">
      <aside>
        <h2>🏠 Family OS</h2>
        <small>Cloudflare-ready v1</small>
      ...
      <section className="main">
        ...
        <div className="grid">
          <article>
            <h3>Today</h3>
            <p>
              Connect Google Calendar to bring your family schedule into this
              dashboard.
            </p>
          </article>
          ...
          <article>
            ...
            <p>Rice, cucumber, tomato, feta.</p>
          </article>

          <article>
            <h3>Household alerts</h3>
            <p>🟡 Dishwasher pods are low.</p>
            <p>🔧 HVAC filter due this week.</p>
          </article>

          <article>
            <h3>What am I forgetting?</h3>
            <p>
              Birthday gift, dentist confirmation and dishwasher pods need
              attention.
            </p>
          </article>
        </div>
